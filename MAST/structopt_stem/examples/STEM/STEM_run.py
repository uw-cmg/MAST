...
if rank==0:
    ...
    atoms_ref=inp_out.read_xyz('/home/usitguest/MAST-structopt_VASP/MAST/structopt_stem/examples/STEM/STEM_ref',0)

    nk = autostemparameters['Pixels']
    A.psf = np.empty([nk,nk],dtype=float)
    fileobj = open('/home/usitguest/MAST-structopt_VASP/MAST/structopt_stem/examples/STEM/PSF.txt', 'r')
    ...
    parameters={'structure':'Cluster',
     ...
     'nindiv': 32, 'maxgen': 4000, 'reqrep': 500,
     'restart': False,
     ...
     'pair_style': 'lj/cut 10.0', 'pair_coeff': '* * 0.4 2.5 10.0',
     'filename': 'Au309',
