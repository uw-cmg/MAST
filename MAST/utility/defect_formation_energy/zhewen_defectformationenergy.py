...
class DefectFormationEnergy:
    ...
    def _calculate_defect_formation_energies(self,scsize):
        ...
        def_dir = ru.read_recipe(self.input_options.get_item("personal_recipe","personal_recipe_list"))[1]
        ...
        e_perf = float(open(self.directory+'/'+perf_dir+'/OSZICAR').readlines()[-1].split('E0=')[1].split()[0])
