...
project = u'MAST'
copyright = u'2014, University of Wisconsin-Madison Compuational Materials Group'
...
version = dirutil.get_version()
# The full version, including alpha/beta/rc tags.
release = dirutil.get_version()
...
man_pages = [
    ('index', 'mast', u'MAST Documentation',
     [u'CMG'], 1)
]
...
texinfo_documents = [
  ('index', 'MAST', u'MAST Documentation',
   u'CMG', 'MAST', 'One line description of project.',
   'Miscellaneous'),
]
