...
*  To give the saddle point structure to the phonon calculation, in :doc:`3_1_1_ingredients`, use ``mast_update_children give_saddle_structure`` for the NEB ingredient type of the NEB parent to the phonon calculation.
